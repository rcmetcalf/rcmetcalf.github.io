...
* For club meetings and other tasks, I use my email as a reminder system. I save "unread" emails in my inbox as reminders to 1) read the email, 2) respond to the email, 3) remember the date or time of an event listed in an email, or 4) research the email topic a little more. Here's some of the unread messages in my inbox:
...
I think it would difficult for someone else to use my organization structure, especially in my "Documents" and "Downloads" folder, because there isn't much of a structure in place. Unless someone knew the name of the document they wanted or the date it was created/modified, they would have a difficult time locating it. I don't a problem using it, though, because I know how I name files. I name notes "subject-class number," like "jomc-137" or "inls-201," but I name written assignments without as much structure. Some are single words, like "leads," and others are slightly more descriptive, like "nc-lottery-article" (view <a href="#docs">Images</a> for an example). Either way, a person using my information structure would have to understand my controlled vocabulary and classification system to use my organization structure.
<br>

<a name="section3.3">c. Percentage of school-related content in digital and physical deskspace</a><br>
I would say only 10-15% of my physical space is occupied by school-related content, most of that being textbooks. I only use a paper notebook in one class because laptops are not allowed. My computer, however, is probably 60-70% school-related content. I do almost everything on my laptop -- write essays, take notes, email professors, access Connect Carolina and Sakai, etc. I almost had to submit my computer for repairs a few weeks ago and PANICKED because my computer is such an important part of my school life. If my computer died or had its memory wiped, I'd really be in trouble (I need to look into cloud storage...). I prefer to store things on my computer, though, because it takes up less physical than multiple notebooks and binders. It's also easier to share information with fellow students or teachers if my information is already digitalized.<br><br>
<a name="section3.4">d. Pros and Cons of my organizational structure</a><br>
I think that my information structure works okay for me. I know how I think and how I name files, so everything (to me) looks like it has an order. My structure is very flexible, and it allows me to make changes in the organization structure without ruining the existing system. If my structure was very rigid, for example, I would constantly need to be following specific naming, dating, and filing conventions to keep the system from falling apart. Because I rely heavily on search functions to find my content, I do very little organizing. The computer sorts for me.
A very big con that I've begun to notice with my system, however, is that it does not work when a lot of information is added. I attend weekly meetings for one club, send emails and coordinate events for another, and try to keep track of classwork and recreational activities. The result is a big jumble of documents on my desktop and more than 15 unread emails in my inbox at all times. My organizational structure works well for small amounts of content, but it's starting to bend under this semester's activity load. I need to start building a more structured system of organization to support this new information. I can start by organizing my documents folder, creating specific class-related repositories on Github, and buying a physical agenda! As much as I love putting information on my computer, I think I need to have a second, non-digital option for organizing my life.
<br><br>
<strong><a name="section4">Images</a></strong><br>
<a name="docs">Documents on my laptop</a><br>
<image src="https://cloud.githubusercontent.com/assets/13002608/9922907/2236c9ba-5cbc-11e5-825f-c1bef8e7de50.png"><br>
